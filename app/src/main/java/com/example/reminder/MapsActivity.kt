  ...
  //      mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney))
    ...
    private fun setLongClick(map: GoogleMap) {
        map.setOnMapLongClickListener { latlng ->
            ...
            builder.setMessage("Do you really want to set this location as your reminder location?")
   ...
   //                 val reminder = SQLiteHelperOfReminder.DataOfReminder()
   ...
   //             createGeoFence(latlng, key!!, geofencingClient)
    ...
    fun showNotification(pendingIntent: PendingIntent, reminder: SQLiteHelperOfReminder.DataOfReminder)
    {
